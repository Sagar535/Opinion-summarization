...
def load(code):
    ...
    '''
    if code == 'mv':
        file1 = "/search/Final_Corpora/Movie/neg1.csv"
        path1 = os.getcwd() + file1
        file2 = "/search/Final_Corpora/Movie/pos1.csv"
        path2 = os.getcwd() + file2
    if code == 'pv':
        file1 = "/search/Final_Corpora/Product_Review/cons1.csv"
        path1 = os.getcwd() + file1
        file2 = "/search/Final_Corpora/Product_Review/pros1.csv"
        path2 = os.getcwd() + file2
    lst1,y1 = ret(path1)
    lst2,y2 = ret(path2)
...
def category_selector():
    ...
    print("Enter 'mv' for Movie Review and 'pv' for product review and 'tt' for twitter")
